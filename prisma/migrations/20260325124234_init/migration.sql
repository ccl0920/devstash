...
CREATE TABLE "_ItemCollections" (
    ...
    CONSTRAINT "_ItemCollections_AB_pkey" PRIMARY KEY ("A","B")
);
...
-- AddForeignKey
ALTER TABLE "items" ADD CONSTRAINT "items_typeId_fkey" FOREIGN KEY ("typeId") REFERENCES "item_types"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "_ItemCollections" ADD CONSTRAINT "_ItemCollections_A_fkey" FOREIGN KEY ("A") REFERENCES "collections"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_ItemCollections" ADD CONSTRAINT "_ItemCollections_B_fkey" FOREIGN KEY ("B") REFERENCES "items"("id") ON DELETE CASCADE ON UPDATE CASCADE;
